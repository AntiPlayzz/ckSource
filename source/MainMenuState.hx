...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		char1 = new Character(600, -230, 'bf', true);
		char1.setGraphicSize(Std.int(char1.width * 0.8));
		add(char1);
		char1.visible = false;

		char2 = new Character(500, -100, 'ckplayable', true);
		char2.setGraphicSize(Std.int(char2.width * 0.9));
		add(char2);
		char2.visible = false;

		char3 = new Character(500, -100, 'placeholder', true);
		char3.setGraphicSize(Std.int(char3.width * 0.8));
		add(char3);
		char3.visible = false;

		char4 = new Character(500, -100, 'placeholder', true);
		char4.setGraphicSize(Std.int(char4.width * 0.8));
		add(char4);
		char4.visible = false;

		char5 = new Character(500, -100, 'placeholder', true);
		char5.setGraphicSize(Std.int(char5.width * 0.8));
		add(char5);
		char5.visible = false;

		char6 = new Character(500, 400, 'discord', true);
		char6.setGraphicSize(Std.int(char6.width * 0.6));
		add(char6);
		char6.visible = false;

		char7 = new Character(500, 600, 'pongey', true);
		char7.setGraphicSize(Std.int(char7.width * 0.9));
		add(char7);
		char7.visible = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				if (optionShit[curSelected] == 'donate')
				{
					CoolUtil.browserLoad('https://discord.gg/K4tpfVZ6Kc');
				}
				else
				{
					selectedSomethin = true;
