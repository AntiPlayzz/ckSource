...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 150, FlxG.width - 800, "lmao bad", 32);
		botplayTxt.setFormat(Paths.font("vcr.ttf"), 200, FlxColor.RED, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		botplayTxt.scrollFactor.set();
		botplayTxt.borderSize = 10;
